    ...
    <div className="flex-1 h-full overflow-y-auto bg-[#f8fafc] custom-scrollbar flex flex-col">
      ...
      <div className="relative overflow-hidden pt-20 pb-20 px-6 shrink-0">
        ...
        <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-brand-100 shadow-sm text-brand-700 text-xs font-bold uppercase tracking-wider mb-8">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-24 w-full">
         <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div 
                onClick={() => onNavigate('GRAPH_BUILDER')}
                className="group relative bg-white rounded-3xl p-8 border border-slate-200 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-brand-900/5 transition-all duration-300 cursor-pointer overflow-hidden h-[300px]"
            >
